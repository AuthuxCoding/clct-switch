...
6. Bundle Identifier 确认是 `com.clctswitch.clctSwitch`
...
3. 填写以下信息：
   ...
   - **套装 ID**：选择 `com.clctswitch.clctSwitch`（如果在列表中没有，需要先去 developer.apple.com → Certificates, Identifiers & Profiles → Identifiers 注册 Bundle ID）
...
2. Bundle ID 选择 **Explicit** → 输入 `com.clctswitch.clctSwitch`
    ...
    <array>
        <dict>
            ...
            <dict>
                ...
                <string>com.clctswitch.clctSwitch</string>
...
3. **App ID**：选择 `com.clctswitch.clctSwitch`
